...
const Footer = () => {
  return (
    <div className="relative  bg-brand w-full bg-blend-multiply py-12">
    <div className="w-full max-w-screen-xl mx-auto grid grid-cols-3 gap-y-12 p-2">
      ...
      <div className="flex col-span-3 lg:col-span-1 items-center justify-center md:items-start md:justify-start">
        <div className="w-full h-full text-white space-y-6">
          <h3 className={`text-lg text-center md:text-start`}>Contact Us</h3>
          <div className="gap-2 flex flex-col md:flex-row justify-center md:justify-start items-center md:items-start">
            ...
            <div>
              ...
              Reventa Homes ,Ranipur Road ,Bethul (Madhya Pradesh)
              </p>
            </div>
          </div>
          <div className="gap-2 flex flex-col md:flex-row justify-center md:justify-start items-center md:items-start">
      ...
      <div className="flex col-span-3 lg:col-span-1 items-center justify-center md:items-start md:justify-start lg:items-center lg:justify-center">
        <div className="flex flex-col items-center justify-center h-full gap-y-4">
          <h3 className={`text-lg text-white  text-center w-fit`}>
         Our Social Media
          </h3>
